...
**/
package com.example.product_api.model; //Paquete donde vive la clase y ayuda a organizar el codigo
...
public class Product {  //Clase publica llamada Product es accesible desde cualquier otra clase del proyecto
    
@Id // Indica que este campo es la clave primaria de la entidad
@GeneratedValue(strategy = GenerationType.IDENTITY) // Genera el ID automáticamente en la base de datos
        
        private Long id; //Atributo privado que define el estado del producto
        private String name; //Atributo privado que define el estado del producto
        //NOTA: Se define private para aplicar encapsulamiento

    //Constructor vacio requerido por Spring
    public Product() {} //Constructor vacio que es requerido por el framework y se usa para instanciar objetos automaticamente

    //Constructor con parametros
    public Product(Long id, String name) { //Permite crear un producto directamente con datos
        this.id = id;
        this.name = name;
    }
